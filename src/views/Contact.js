          ...
          <div class="row row-50">
            ...
            <div class="col-md-6 col-lg-4">
              <div class="box-icon-classic">
                ...
                <div class="box-icon-caption">
                  <h4>51 Francis Street, Darlinghurst NSW 2010, United States</h4>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-9 col-lg-7">
              ...
              <form class="rd-form rd-mailform" data-form-output="form-output-global" data-form-type="contact" method="post" action="{{route('contact.store')}}"> 
                ...
                <div class="form-wrap">
                  ...
                  <textarea class="form-input" id="contact-message" name="message" data-constraints="@Required"/>
                </div>
                <div class="row justify-content-center">
