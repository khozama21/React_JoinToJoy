        ...
        <h2> Fill Your Application </h2>
            ...
            <form onSubmit={handdleSubmit}  >
                ...
                <div class="form-group">
                    ...
                    <input className='form-control' type="text" required value={place} onChange={e => { setPlace(e.target.value) }} placeholder="House, Farm, Hall..." />
                </div>
                <div class="form-group">
                    <label>Date of Event</label>
                    <input className='form-control' type="date" required value={date} onChange={e => { setDate(e.target.value) }} placeholder="Date Of Event" />
                </div>
                <div class="form-group">
                    <label>Theme Of Event</label>
                    <input className='form-control' required value={theme} onChange={e => { setTheme(e.target.value) }} placeholder="Theme Of Event" />
                </div>
                <label> Category </label>
                <select className='form-control' required type="text" value={category} onChange={e => { setCategory(e.target.value) }} >
